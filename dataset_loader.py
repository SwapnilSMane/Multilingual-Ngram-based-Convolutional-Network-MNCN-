...
word_em_nl = models.KeyedVectors.load_word2vec_format('embeddings/wiki.multi.nl.vec')
word_em_en = models.KeyedVectors.load_word2vec_format('embeddings/wiki.multi.en.vec')
word_em_fr = models.KeyedVectors.load_word2vec_format('embeddings/wiki.multi.fr.vec')
word_em_es = models.KeyedVectors.load_word2vec_format('embeddings/wiki.multi.es.vec')
word_em_ru = models.KeyedVectors.load_word2vec_format('embeddings/wiki.multi.ru.vec')
word_em_tr = models.KeyedVectors.load_word2vec_format('embeddings/wiki.multi.tr.vec')
        ...
        for word in self.data[item][0]:
            ...
            try:
                if self.language == 'english':
                    ...
                    word_emb = word_em_ru[word]
                elif self.language == 'turkish':
                    word_emb = word_em_tr[word]
...
def singledataset_loader(validation_percentage, language, redundant=False):
    ...
    if language == 'english':
        ...
        dataset = SimpleDataset('data/se16_ru_rest_train.xml',
                                'data/RU_REST_SB1_TEST.xml.gold', validation_percentage=validation_percentage,
                                language=language, redundant=redundant)
    elif language == 'turkish':
        dataset = SimpleDataset('data/reviews_TU_train.xml',
                                'data/TU_REST_SB1_TEST.xml.gold', validation_percentage=validation_percentage,
                                language=language, redundant=redundant)
